<template>
  <div v-if="template" class="fixed inset-0 z-50 grid place-items-center bg-ink/70 p-4" @click.self="$emit('close')">
    <div class="w-full max-w-4xl rounded-lg bg-white p-4 shadow-soft">
